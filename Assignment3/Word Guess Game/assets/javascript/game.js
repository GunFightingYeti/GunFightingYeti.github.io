...
// document.onkeyup = function mWArray (mysteryWord) {
//     var xyz = mysteryWord
//     return xyz.split("")
//     console.log(xyz)
// }

// function newGame(xyz) {
//     var xyz = prompt("Please enter a word or phrase:");
//     return xyz = xyz.split('');
//     console.log("newGame: " + xyz);
...
document.onkeyup = function (event) {
    ...
    //      alert("Stop thinking outside the box!")
